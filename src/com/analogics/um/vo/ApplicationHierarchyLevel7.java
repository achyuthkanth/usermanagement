...
/**
 * ApplicationHierarchyLevel7 entity. @author MyEclipse Persistence Tools
 */

public class ApplicationHierarchyLevel7 implements java.io.Serializable {
	...
	/** default constructor */
	public ApplicationHierarchyLevel7() {
	}

	/** minimal constructor */
	public ApplicationHierarchyLevel7(Integer level7Id) {
		this.level7Id = level7Id;
	}

	/** full constructor */
	public ApplicationHierarchyLevel7(Integer level7Id, String level7Name,
			String level7Code, String level7Uniquecode, Integer level6Id) {
		this.level7Id = level7Id;
