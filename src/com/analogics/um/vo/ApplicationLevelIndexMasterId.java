...
/**
 * ApplicationLevelIndexMasterId entity. @author MyEclipse Persistence Tools
 */

public class ApplicationLevelIndexMasterId implements java.io.Serializable {
	...
	/** default constructor */
	public ApplicationLevelIndexMasterId() {
	}

	/** full constructor */
	public ApplicationLevelIndexMasterId(Integer level15id, Integer level14id,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ApplicationLevelIndexMasterId))
			return false;
		ApplicationLevelIndexMasterId castOther = (ApplicationLevelIndexMasterId) other;
