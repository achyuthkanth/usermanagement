...
/**
 * ApplicationHierarchyLevel5 entity. @author MyEclipse Persistence Tools
 */

public class ApplicationHierarchyLevel5 implements java.io.Serializable {
	...
	/** default constructor */
	public ApplicationHierarchyLevel5() {
	}

	/** minimal constructor */
	public ApplicationHierarchyLevel5(String level5Uniquecode, Integer level5Id) {
		this.level5Uniquecode = level5Uniquecode;
		this.level5Id = level5Id;
	}

	/** full constructor */
	public ApplicationHierarchyLevel5(String level5Uniquecode,
			Integer level5Id, String level5Name, String level5Code,
			Integer level4Id) {
		this.level5Uniquecode = level5Uniquecode;
		this.level5Id = level5Id;
