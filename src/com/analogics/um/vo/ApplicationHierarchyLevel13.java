...
/**
 * ApplicationHierarchyLevel13 entity. @author MyEclipse Persistence Tools
 */

public class ApplicationHierarchyLevel13 implements java.io.Serializable {
	...
	/** default constructor */
	public ApplicationHierarchyLevel13() {
	}

	/** minimal constructor */
	public ApplicationHierarchyLevel13(Integer level13Id) {
		this.level13Id = level13Id;
	}

	/** full constructor */
	public ApplicationHierarchyLevel13(Integer level13Id, String level13Name,
