...
/**
 * ApplicationHierarchyLevel15 entity. @author MyEclipse Persistence Tools
 */

public class ApplicationHierarchyLevel15 implements java.io.Serializable {
	...
	/** default constructor */
	public ApplicationHierarchyLevel15() {
	}

	/** minimal constructor */
	public ApplicationHierarchyLevel15(Integer level15Id) {
		this.level15Id = level15Id;
	}

	/** full constructor */
	public ApplicationHierarchyLevel15(Integer level15Id, String level15Name,
