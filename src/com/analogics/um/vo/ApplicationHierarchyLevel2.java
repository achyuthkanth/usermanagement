...
/**
 * ApplicationHierarchyLevel2 entity. @author MyEclipse Persistence Tools
 */

public class ApplicationHierarchyLevel2 implements java.io.Serializable {
	...
	/** default constructor */
	public ApplicationHierarchyLevel2() {
	}

	/** minimal constructor */
	public ApplicationHierarchyLevel2(String level2Uniquecode, Integer level2Id) {
		this.level2Uniquecode = level2Uniquecode;
		this.level2Id = level2Id;
	}

	/** full constructor */
	public ApplicationHierarchyLevel2(String level2Uniquecode,
			Integer level2Id, String level2Name, String level2Code,
			Integer level1Id) {
		this.level2Uniquecode = level2Uniquecode;
		this.level2Id = level2Id;
