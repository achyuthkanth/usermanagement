...
/**
 * ApplicationHierarchyLevel4 entity. @author MyEclipse Persistence Tools
 */

public class ApplicationHierarchyLevel4 implements java.io.Serializable {
	...
	/** default constructor */
	public ApplicationHierarchyLevel4() {
	}

	/** minimal constructor */
	public ApplicationHierarchyLevel4(String level4Uniquecode, Integer level4Id) {
		this.level4Uniquecode = level4Uniquecode;
		this.level4Id = level4Id;
	}

	/** full constructor */
	public ApplicationHierarchyLevel4(String level4Uniquecode,
			Integer level4Id, String level4Name, String level4Code,
			Integer level3Id) {
		this.level4Uniquecode = level4Uniquecode;
		this.level4Id = level4Id;
