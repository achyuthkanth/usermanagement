...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
			...
			<%@ include file="WEB-INF/views/common/hierarchies.jsp"%>
						...
						<div class="col-12">
							<div class="card card-secondary">
								...
								<div class="card-body">
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												<label>Meter No</label> <input type="text" class="form-control"
						                      ...
						                      <div class="form-group">
												...
												<div class="custom-control custom-checkbox">
													<input
														...
														type="checkbox" id="customCheckbox4" checked> <label
														for="customCheckbox4" class="custom-control-label">Custom
														Checkbox with custom color</label>
												</div>
												<div class="custom-control custom-checkbox">
													<input
														class="custom-control-input custom-control-input-danger custom-control-input-outline"
														type="checkbox" id="customCheckbox5" checked> <label
														for="customCheckbox5" class="custom-control-label">Custom
									...
									<div class="form-group">
										<label for="customRange2">Custom range
											(custom-range-danger)</label> <input type="range"
											class="custom-range custom-range-danger" id="customRange2">
									</div>
									<div class="form-group">
										<label for="customRange3">Custom range
											(custom-range-teal)</label> <input type="range"
											class="custom-range custom-range-teal" id="customRange3">
									</div>
									<div class="form-group">
