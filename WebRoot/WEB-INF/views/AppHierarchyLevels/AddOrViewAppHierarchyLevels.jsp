					...
					<div class="content-wrapper">
						...
						<section class="content-header">
							<div class="container-fluid">
								<div class="row mb-2">
									<div class="col-sm-6">
										<h1>Application Hierarchy Levels</h1> </div>
									<div class="col-sm-6">
										<ol class="breadcrumb float-sm-right">
											<li class="breadcrumb-item"><a href="#">Home</a> </li>
											<li class="breadcrumb-item active">Application Hierarchy Levels </li>
										</ol>
									</div>
								</div>
							</div>
							...
							<div class="container-fluid">
								...
								<div class="card card-default">
									<div class="card-header">
										<h3 class="card-title">Upload Application Hierarchy Levels</h3>
									...
									<div class="card-body">
												...
												<form:form method="post" action="saveHierarchies" enctype="multipart/form-data">
													<div id="information-part" class="content" role="tabpanel" aria-labelledby="information-part-trigger">
														<div class="form-group">
															<label for="exampleInputFile">Upload Application Hierarchy CSV file</label>
										...
										<div class="form-group col-sm-12" style="text-align: center;">
											<button type="submit" class="btn btn-success">Upload Hierarchies</button>
										</div>
									</div>
								</div>
							</div>
						...
						<section class="content">
							<div class="container-fluid">
								...
								<div class="card card-default">
									<div class="card-header">
										<h3 class="card-title">Application Hierarchy  Information</h3>
										<div class="card-tools">
											<button type="button" class="btn btn-tool" data-card-widget="collapse"> <i class="fas fa-minus"></i> </button>
										</div>
									</div>
									...
									<div class="card-body">
										...
										<div class="form-group col-sm-12" style="text-align: center;">
											<button type="submit" class="btn btn-success submitClass">View Application Hierarchy </button>
										</div>
									</div>
								</div>
							</div>
						...
						<section class="content">
							<div class="container-fluid">
								<a class='updateCall' href='javascript:void(0)'>
									<input type="button" id="myDataToggle" data-toggle='modal' data-target='#addtagblock' style="display: none;" /> </a>
								<div class="card card-default">
												...
												<div class="modal-content" style="width: 830px;">
													...
													<div class="modal-body" id="searchMainId">
																...
																<table>
																	<tr>
																		...
																		<td>
																			...
																			<input name="levelName" id="levelName" class="text_field"></input>
																		</td>
																	</tr>
																	<tr>
																		<td></td>
																		...
																		<td>
																			...
																			<input name="levelCode" id="levelCode" class="text_field" />
																			<input type="hidden" value="" id="levelIdRef" />
																			<input type="hidden" value="" id="levelValue" />
																			<input type="hidden" value="" id="levelCount" /> </td>
																	</tr>
																</table>
															</div>
														</form>
														<div class="modal-footer">
															...
															<input type="reset" class="btn btn-primary" value="Reset" />
															<input type="submit" class="btn btn-primary" id="appLevelsSubmitButton" value="Save" /> </div>
													</div>
												</div>
											</div>
										</div>
